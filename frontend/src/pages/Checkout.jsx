...
export default function Checkout({ navigate }) {
  ...
  return (
    <section ref={revealRef} className="container checkout-layout">
      <form className="checkout-form reveal-item" onSubmit={submit}>
      ...
      <aside className="summary-card reveal-item reveal-delay-2">
